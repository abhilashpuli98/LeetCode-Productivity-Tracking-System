export const languageMap = {
  ...
  // alternative names merged here
  "c++": { langName: "cpp", extension: ".cpp" },
  "c#": { langName: "csharp", extension: ".cs" },
  go: { langName: "golang", extension: ".go" },
  postgres: { langName: "postgresql", extension: ".sql" }
};
